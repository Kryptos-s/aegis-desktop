...
public class IconPackManager {
    ...
    /**
     * @param iconsBaseDir directory that installed icon packs are unpacked into. Icon packs are
     *                     untrusted zip archives, so they get a directory of their own rather than
     *                     sharing one with the vault.
     */
    public IconPackManager(File iconsBaseDir) {
        _iconPacks = new ArrayList<>();
        _iconsBaseDir = iconsBaseDir;
        rescanIconPacks();
    }
