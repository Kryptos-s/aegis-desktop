...
public class IOUtils {
    ...
    /**
     * Returns the part of the file name after its last dot, or an empty string if it has none.
     * Matches the behaviour of Guava's {@code Files.getFileExtension}.
     */
    ...
    /**
     * Returns the file name with its extension removed. Matches the behaviour of Guava's
     * {@code Files.getNameWithoutExtension}.
     */
